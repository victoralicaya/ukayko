...
$banner_id = (isset($_GET['wtsmbID'])) ? (int)$_GET['wtsmbID'] : 0;
...
if ($banner_id) {
  $banner = $db->Execute("SELECT *
                          ...
                          WHERE wtsmb_id = " . (int)$banner_id);

  $years = $db->Execute("SELECT DISTINCT year(wtsmbh_history_date) AS banner_year
...
<!--[if lte IE 8]><script src="includes/javascript/flot/excanvas.min.js"></script><![endif]-->
    ...
    <div class="container-fluid" id="pageWrapper">
      ...
      <?php echo zen_draw_hidden_field('wtsmbID', $banner_id); ?>
      ...
      <div class="row text-right">
        <a href="<?php echo zen_href_link(FILENAME_BANNER_MANAGER, 'page=' . (int)$_GET['page'] . '&wtsmbID=' . $banner_id); ?>" class="btn btn-default" role="button"><?php echo IMAGE_BACK; ?></a>
      </div>
...
<?php } ?>
  ...
  <div class="row text-right">
    <a href="<?php echo zen_href_link(FILENAME_BANNER_MANAGER, 'page=' . (int)$_GET['page'] . '&wtsmbID=' . (int)$_GET['wtsmbID']); ?>" class="btn btn-default" role="button"><?php echo IMAGE_BACK; ?></a>
  </div>
</div>
<!-- body_eof //-->
