...
<footer>
  <div id="footer">
    <a href="" rel="noopener" target="_blank"><img src="images/<?php echo HEADER_LOGO_IMAGE;?>" alt="Ukayko"></a><br>
    <br>
    Ukayko Copyright &copy; 2003-<?php echo date('Y'); ?> <a href="" rel="noopener" target="_blank">Ukayko&reg;</a><br>
