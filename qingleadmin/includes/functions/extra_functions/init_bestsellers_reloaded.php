...
if (!defined ('SHOW_PRODUCT_INFO_MAIN_BEST_SELLERS')) {
  $db->Execute ("INSERT INTO " . TABLE_CONFIGURATION . " ( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function ) VALUES ( 'Show Best Sellers - Main Page', 'SHOW_PRODUCT_INFO_MAIN_BEST_SELLERS', '1', 'Show the <em>Best Sellers</em> on the main page? Set to <em>0</em> to disable or set the sort order for the display.', $cgi, 5, NULL , NULL)");
  
  $db->Execute ("INSERT INTO " . TABLE_CONFIGURATION . " ( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function ) VALUES ( 'Show Best Sellers - Main Page w/ Categories', 'SHOW_PRODUCT_INFO_CATEGORY_BEST_SELLERS', '1', 'Show the <em>Best Sellers</em> on the categories\' listings? Set to <em>0</em> to disable or set the sort order for the display.', $cgi, 10, NULL , NULL)");
  ...
  $db->Execute ("INSERT INTO " . TABLE_CONFIGURATION . " ( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function ) VALUES ( 'Best Sellers - Image Width', 'IMAGE_BEST_SELLERS_LISTING_WIDTH', '263', 'The width of the <em>Best Sellers</em> images.', $cgi, 25, NULL , NULL)");

  $db->Execute ("INSERT INTO " . TABLE_CONFIGURATION . " ( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function ) VALUES ( 'Best Sellers - Image Height', 'IMAGE_BEST_SELLERS_LISTING_HEIGHT', '0', 'The height of the <em>Best Sellers</em> images.', $cgi, 30, NULL, NULL)");
