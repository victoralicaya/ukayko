...
$module_constant = 'CSS_JS_LOADER_VERSION';
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/css_js_loader';
$module_name = "CSS/JS Loader";
$zencart_com_plugin_id = 1774; // from zencart.com plugins - Leave Zero not to check
...
if (file_exists(DIR_FS_ADMIN . 'includes/installers/css_js_loader/' . 'new_install.php')) {
    @unlink(DIR_FS_ADMIN . 'includes/installers/css_js_loader/' . 'new_install.php');
}
