...
if ($news_box_format == 'Individual') {
    ...
    $news_box_query_raw =
        "SELECT n.box_news_id, nc.news_title, nc.news_content, n.news_start_date, n.news_end_date, n.news_content_type, n.news_image, n.news_added_date, n.news_modified_date
