...
//
$define = [
    'NAVBAR_TITLE' => 'News Archive',
    'HEADING_TITLE' => 'News Archive',
    'TEXT_NO_NEWS_CURRENTLY' => 'We currently have no articles published.  Check back soon!',
    'TEXT_NEWS_LAST_UPDATED' => 'Updated On : ',
    'TEXT_DISPLAY_NUMBER_OF_NEWS_ARTICLES' => 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> news articles)',
];
