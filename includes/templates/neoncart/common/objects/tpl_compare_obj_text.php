<a href="<?php echo zen_href_link(FILENAME_COMPARE, '', 'SSL'); ?>" target="_blank" class="tt-obj-link tt-compare-wrapper header-icon-badge" data-tooltip="<?php echo HEADER_TOP_COMPARE_TEXT; ?>" data-tposition="bottom">
	<div class="tt-dropdown-toggle">
		<?php $compare_count = ( !empty( $_SESSION['compare'] ) ) ? count($_SESSION['compare']) : 0; ?>
		<span class="tt-badge compareCount <?php echo ( $compare_count == 0  )? 'hide' : ''; ?>" style=""><?php echo $compare_count; ?></span>
		<i>
		...
		<span class="tt-text"><?php echo HEADER_TOP_COMPARE_TEXT; ?></span>
