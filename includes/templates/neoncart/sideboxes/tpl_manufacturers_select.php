...
$content .= zen_draw_label(PLEASE_SELECT, 'select-manufacturers_id', 'class="sr-only"');
  $content .= '<div class="select-wrapper-sm d-lg-inline-block">' . zen_draw_pull_down_menu('manufacturers_id', $manufacturer_sidebox_array, $default_selection, 'size="' . MAX_MANUFACTURERS_LIST . '"' . $required) . zen_hide_session_id() . '</div>';
