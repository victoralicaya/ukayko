...
$content .= '<div class="select-wrapper-sm d-lg-inline-block">' . zen_draw_pull_down_menu('currency', $currencies_array, $_SESSION['currency']) . $hidden_get_variables . zen_hide_session_id() . '</div>';
