...
<div class="mainContent success alert alert-success"><?php echo TEXT_SUCCESS; ?></div>
...
<fieldset id="contactUsForm" class="card-body">
<h4 class="h4-style item_title"><?php echo FORM_TITLE; ?></h4>
...
<?php echo zen_draw_input_field('telephone', ($telephone), ' size="20" id="telephone" class="form-control" autocomplete="off" placeholder="' . ENTRY_REQUIRED_SYMBOL . '" required', 'tel'); ?>
<br class="clearBoth">
