...
<fieldset class="address-details tt-item card">
<div class="card-body">
<h2 class="tt-title"><?php echo TABLE_HEADING_ADDRESS_DETAILS; ?></h2>
<?php
  if (ACCOUNT_GENDER == 'true') {
?>
<?php echo zen_draw_radio_field('gender', 'm', '', 'id="gender-male"') . '<label class="radioButtonLabel" for="gender-male">' . MALE . '</label>' . zen_draw_radio_field('gender', 'f', '', 'id="gender-female"') . '<label class="radioButtonLabel" for="gender-female">' . FEMALE . '</label>' . (!empty(ENTRY_GENDER_TEXT) ? '<span class="alert-text">' . ENTRY_GENDER_TEXT . '</span>': ''); ?>
<br class="clearBoth">
<?php
  }
?>
...
<br class="clearBoth">
<label class="inputLabel" for="country"><?php echo ENTRY_COUNTRY; ?><?php echo (!empty(ENTRY_COUNTRY_TEXT) ? '<span class="alert-text">' . ENTRY_COUNTRY_TEXT . '</span>': ''); ?></label>
...
<?php } ?>
<label class="inputLabel hiddenField" for="state" id="stateLabel"><?php echo $state_field_label; ?><?php echo zen_not_null(ENTRY_STATE_TEXT) ? '<span class="alert-text">' . ENTRY_STATE_TEXT . '</span>': ''; ?></label>
<?php
...
<fieldset class="address-details tt-item card">
<div class="card-body">
<h2 class="tt-title"><?php echo TABLE_HEADING_DATE_OF_BIRTH; ?></h2>
...
<fieldset class="address-details tt-item card">
<div class="card-body">
<h2 class="tt-title"><?php echo TABLE_HEADING_PHONE_FAX_DETAILS; ?></h2>
...
<fieldset class="address-details tt-item card">
<div class="card-body">
<h2 class="tt-title"><?php echo TABLE_HEADING_LOGIN_DETAILS; ?></h2>
...
<fieldset class="address-details tt-item card">
<div class="card-body">
<h2 class="tt-title"><?php echo ENTRY_EMAIL_PREFERENCE; ?></h2>
<?php
...
<fieldset class="address-details tt-item card">
<div class="card-body">
<h2 class="tt-title"><?php echo TABLE_HEADING_PRIVACY_CONDITIONS; ?></h2>
...
<fieldset class="address-details tt-item card">
<div class="card-body">
<h2 class="tt-title"><?php echo TABLE_HEADING_REFERRAL_DETAILS; ?></h2>
