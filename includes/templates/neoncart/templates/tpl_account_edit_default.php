 ...
 */
?>
<div class="centerColumn tt-shopping-layout" id="accountEditDefault">
  ...
  <?php if ($messageStack->size('account_edit') > 0) echo $messageStack->output('account_edit'); ?>
    <h1 class="tt-title noborder text-left"><?php echo HEADING_TITLE; ?></h1>
      ...
      <fieldset>
        ...
        <br class="clearBoth" />
        <?php } ?>
        <h4 class="tt-title pb-1"><?php echo ENTRY_EMAIL_PREFERENCE; ?></h4>
      ...
      <div class="next-prev buttonsRow">
