...
<div class="centerColumn" id="checkoutShipAddressDefault">
  <h1 id="checkoutShipAddressDefaultHeading" class="tt-title noborder text-left"><?php echo HEADING_TITLE; ?></h1>
  ...
  <div class="tt-card-box">
    <h4 id="checkoutShipAddressDefaultAddress" class="tt-title"><?php echo TITLE_SHIPPING_ADDRESS; ?></h4>
    <div class="instructions group">
      <address class="back"><?php echo zen_address_label($_SESSION['customer_id'], $_SESSION['sendto'], true, ' ', '<br>'); ?></address>
      <?php if ($addresses_count < MAX_ADDRESS_BOOK_ENTRIES) echo '<div class="alert alert-info">'.TEXT_CREATE_NEW_SHIPPING_ADDRESS.'</div>'; ?>
    </div>
  </div>
  <?php
  ...
  ?>
      ...
      <div class="tt-card-box">
        <h4 class="tt-title"><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?></h4>
        <?php
  ...
  ?>
  <div class="buttonRow back clearBoth text-end"><?php echo zen_back_link() . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>'; ?></div>
</div>
