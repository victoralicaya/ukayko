...
<div id="sendSpendWrapper" class="forward card card--padding">
<h2 class="h4-style"><?php echo TEXT_AVAILABLE_BALANCE;?></h2>
...
<div id="gvSendDefaultContentSuccess" class="content card card--padding"><?php echo TEXT_SUCCESS; ?></div>
...
<div id="gvSendDefaultMainMessage" class="content card card--padding"><?php echo sprintf(MAIN_MESSAGE, $currencies->format($currencies->normalizeValue($_POST['amount']), false), $to_name, $_POST['email']); ?></div>

<div id="gvSendDefaultMessageSecondary" class="content card card--padding"><?php echo sprintf(SECONDARY_MESSAGE, $to_name, $currencies->format($currencies->normalizeValue($_POST['amount']), false), $send_name); ?></div>
<?php
    if (!empty($_POST['message'])) {
?>

<div id="gvSendDefaultMessagePersonal" class="content card card--padding"><?php echo sprintf(PERSONAL_MESSAGE, $send_firstname); ?></div>

<div id="gvSendDefaultMessage" class="content card card--padding"><?php echo stripslashes($_POST['message']); ?></div>
<?php
    }
...
?>
<div class="next-prev">
<div class="buttonRow forward change_address"><?php echo zen_image_submit(BUTTON_IMAGE_CONFIRM_SEND, BUTTON_CONFIRM_SEND_ALT); ?></div>
<div class="buttonRow back change_address"><?php echo zen_image_submit(BUTTON_IMAGE_EDIT_SMALL, BUTTON_EDIT_SMALL_ALT, 'name="edit" value="edit"'); ?></div>
  </div>
    <?php echo '</form>'; ?>
<br class="clearBoth" />

<div class="advisory alert alert-info"><?php echo EMAIL_ADVISORY_INCLUDED_WARNING . str_replace('-----', '', EMAIL_ADVISORY); ?></div>
<!--EOF GV send confirm -->
<?php
 } else {
?>
...
<div id="gvSendDefaultMainContent" class="content card card--padding"><?php echo HEADING_TEXT; ?></div>
<br class="clearBoth" />
<?php
...
<legend class="h4-style"><?php echo HEADING_TITLE; ?></legend>
...
<br class="clearBoth" />
<div class="next-prev">
<div class="buttonRow forward change_address"><?php echo zen_image_submit(BUTTON_IMAGE_SEND, BUTTON_SEND_ALT); ?></div>
<div class="buttonRow back change_address"><?php echo zen_back_link() . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>'; ?></div>
</div>
</div>
</form>
<br class="clearBoth" />
