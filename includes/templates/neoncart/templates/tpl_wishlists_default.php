		...
		<div class="wishlist<?php echo (!un_is_empty($tdclass)? '-'.$tdclass: ''); ?>">
			<div class="tt-card-box">
                ...
                <div class="buttons" style="float:none;margin-top:10px;text-align:left">
                    <a class="btn btn-sm" href="<?php echo zen_href_link(UN_FILENAME_WISHLIST_EDIT, 'wid='.$records->fields['id'].'&op=edit', 'SSL'); ?>" title="<?php echo BUTTON_EDIT_SMALL_ALT; ?>"><?php echo BUTTON_EDIT_SMALL_ALT; ?></a>
                    <a class="btn btn-sm" href="<?php echo zen_href_link(UN_FILENAME_WISHLISTS, 'wid='.$records->fields['id'].'&op=del', 'SSL'); ?>" title="<?php echo  BUTTON_DELETE_SMALL_ALT; ?>"><?php echo BUTTON_DELETE_SMALL_ALT; ?></a>
                </div>
			</div>
