...
<div class="centerColumn" id="compareDefault">
    ...
    <div class="row"> 
        <div id="compareDefaultMainContent" class="copmare-wrapper col-lg-12 col-md-6 com-sm-4 col-xs-12">
        <?php
        ...
        if (!empty($_SESSION['compare'])) {
            ...
            $comp_value_count = (count($result) < COMPARE_VALUE_COUNT)
                ? count($result)
                : COMPARE_VALUE_COUNT;
            echo '<div class="table-responsive"><table class="table table-compare table-striped table-bordered">';
