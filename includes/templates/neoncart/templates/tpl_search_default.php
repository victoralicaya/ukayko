...
<fieldset class="card card--padding mt-4">
...
<br class="clearBoth">
    <div class="centeredContent"><?php echo zen_draw_input_field('keyword', $sData['keyword'], 'class="form-control" placeholder="' . KEYWORD_FORMAT_STRING . '" autofocus aria-label="' . KEYWORD_FORMAT_STRING . '"', 'search'); ?>
        <p class="d-flex mt-2"><?php echo zen_draw_checkbox_field('search_in_description', '1', $sData['search_in_description'], 'id="search-in-description"'); ?>
        <label class="checkboxLabel" for="search-in-description"><?php echo TEXT_SEARCH_IN_DESCRIPTION; ?></label></p></div>
<br class="clearBoth">
</fieldset>

<div class="row">
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
<fieldset class="floatingBox back card card--padding">
...
<fieldset class="floatingBox forward card card--padding">
