...
<h2 class="text-center text-uppercase tt-title"><?php echo CART_SHIPPING_OPTIONS; ?></h2>
</div>
...
<div class="card card--padding tt-shopcart-box">
<div class="card-body">
<?php
...
<div class="bold back h4-style" id="seShipTo"><?php echo CART_SHIPPING_METHOD_TO; ?></div>
...
?>
<table class="table" id="seQuoteResults">
