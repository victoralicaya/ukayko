...
<div class="centerColumn" id="addressBookProcessDefault">
  ...
  <h1 id="addressBookProcessDefaultHeading" class="tt-title noborder text-left"><?php if (isset($_GET['edit'])) { echo HEADING_TITLE_MODIFY_ENTRY; } elseif (isset($_GET['delete'])) { echo HEADING_TITLE_DELETE_ENTRY; } else { echo HEADING_TITLE_ADD_ENTRY; } ?></h1>
