...
<div class="centerColumn" id="accountHistInfo">
    ...
    <h4 class="tt-title"><?php echo HEADING_ORDER_DATE . ' ' . zen_date_long($order->info['date_purchased']); ?></h4>
    <br class="clearBoth" />
    <?php if ($current_page != FILENAME_CHECKOUT_SUCCESS) { ?>
      <h5 id="orderHistoryDetailedOrder" class="tt-title"><?php echo HEADING_TITLE . ORDER_HEADING_DIVIDER . sprintf(HEADING_ORDER_NUMBER, zen_output_string_protected($_GET['order_id'])); ?></h5>
    <?php } ?>
    <div class="table-responsive">
      <table id="orderHistoryHeading" class="table table-bordered">
  ...
  if (DOWNLOAD_ENABLED == 'true') { ?>
    <?php require($template->get_template_dir('tpl_modules_downloads.php',DIR_WS_TEMPLATE, $current_page_base,'templates'). '/tpl_modules_downloads.php'); ?>
  <?php } ?>
  <div class="tt-card-box">
    <?php
    /**
    ...
    ?>
    <h4 id="orderHistoryStatus" class="tt-title"><?php echo HEADING_ORDER_HISTORY; ?></h4>
    <div class="table-responsive">
      <table id="myAccountOrdersStatus" class="table table-bordered">
        <tr class="tableHeading">
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 shipinfo-delivery-address">
        <div id="myAccountShipInfo" class="floatingBox back">
          ...
          ?>
            <h4 class="tt-title"><?php echo HEADING_DELIVERY_ADDRESS; ?></h4>
      ...
      ?>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 shipinfo-shipping-address">
        <h4 class="tt-title"><?php echo HEADING_SHIPPING_METHOD; ?></h4>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 shipinfo-billing-address">
        <div id="myAccountPaymentInfo" class="floatingBox forward">
          <h4 class="tt-title"><?php echo HEADING_BILLING_ADDRESS; ?></h4>
          <address><?php echo zen_address_format($order->billing['format_id'], $order->billing, 1, ' ', '<br />'); ?></address>
        </div>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 shipinfo-payment-method">
        <h4 class="tt-title"><?php echo HEADING_PAYMENT_METHOD; ?></h4>
