...
?>
<div id="sendSpendWrapper" class="card card--padding">
...
<div id="gvFaqDefaultMainContent" class="content card card--padding"><?php echo TEXT_INFORMATION; ?></div>
<div class="alert alert-info alert-dismissable">
<h2 class="h4-style" id="gvFaqDefaultSubHeading"><?php echo $subHeadingTitle; ?></h2>
...
<fieldset>
<legend class="h4-style"><?php echo TEXT_GV_REDEEM_INFO; ?></legend>
