...
<div class="centerColumn" id="checkoutPayment">
  ...
  <h1 id="checkoutPaymentHeading" class="tt-title mb-4"><?php echo HEADING_TITLE; ?></h1>
  ...
  <div class="tt-card-box">
    <?php // ** BEGIN PAYPAL EXPRESS CHECKOUT **
      ...
      <h4 id="checkoutPaymentHeadingAddress" class="tt-title"><?php echo TITLE_BILLING_ADDRESS; ?></h4>
      <div id="checkoutBillto" class="floatingBox back">
        ...
        <div class="buttonRow forward"><?php echo '<a class="btn btn-sm" href="' . zen_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '">' . BUTTON_CHANGE_ADDRESS_ALT . '</a>'; ?></div>
        <?php } ?>
      </div>
      <br class="clearBoth" />
      <div class="floatingBox important forward alert alert-info mb-0"><?php echo TEXT_SELECTED_BILLING_DESTINATION; ?></div>
    <?php // ** BEGIN PAYPAL EXPRESS CHECKOUT **
    }
    // ** END PAYPAL EXPRESS CHECKOUT ** ?>
  </div>
  ...
  <div class="tt-card-box">
    <fieldset id="checkoutOrderTotals">
      <h4 class="tt-title" id="checkoutPaymentHeadingTotal"><?php echo TEXT_YOUR_TOTAL; ?></h4>
      <?php
  ...
  ?>
  <div class="messageStackError alert alert-error"><?php echo zen_output_string_protected($_GET['credit_class_error']); ?></div>
  ...
  <div class="tt-card-box">
    <fieldset>
      <h4 class="tt-title"><?php echo $selection[$i]['module']; ?></h4>
  ...
  <div class="tt-card-box">
    <fieldset>
      <h4 class="tt-title"><?php echo TABLE_HEADING_CONDITIONS; ?></h4>
  ...
  <div class="row checkout-shipping-button">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7 mb-2 mb-lg-0 text-end">
