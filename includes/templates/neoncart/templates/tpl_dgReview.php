...
?>
  <?php // change the class name here to reflect your CSS page ?>
	<div class="product_info_ratings tt-item">
        <h4 class="tt-comment-title list_title"><?php echo zen_output_string_protected($reviews->fields['customers_name']); ?></h4>
		<span class="review-item_rating tt-rating d-block">
		<?php echo sprintf(zen_image(DIR_WS_TEMPLATE_IMAGES . 'stars_' . $reviews->fields['reviews_rating'] . '_small.png'));?>
		</span>
		<p><?php echo zen_break_string(zen_output_string_protected(stripslashes($reviews->fields['reviews_text'])), 35, '-<br />')?></p>
	</div>
<?php
      $reviews->MoveNext();
    }
