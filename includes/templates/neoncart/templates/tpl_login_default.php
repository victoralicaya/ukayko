 ...
 */
?>
<div class="centerColumn container-indent tt-login-form" id="loginDefault">
    <h1 id="loginDefaultHeading" class="tt-title noborder text-left"><?php echo HEADING_TITLE; ?></h1>
	...
	<div class="row">
        ...
        <div class="tt-item floatingBox back card">
			<div class="card-body">
            <h2 class="tt-title"><?php echo HEADING_NEW_CUSTOMER_SPLIT; ?></h2>

            <?php // ** BEGIN PAYPAL EXPRESS CHECKOUT ** ?>
            <?php if ($ec_button_enabled) { ?>
                <div class="information mb-0"><?php echo TEXT_NEW_CUSTOMER_INTRODUCTION_SPLIT; ?></div>
            ...
            <div class="buttonRow forward"><?php echo zen_image_submit(BUTTON_IMAGE_CREATE_ACCOUNT, BUTTON_CREATE_ACCOUNT_ALT, 'name="registrationButton"', 'btn-top btn-border'); ?></div>
            <?php echo '</form>'; ?>
		</div>
        </div>
		</div>
		<div class="col-xs-12 col-md-6">
        <div class="tt-item form-group floatingBox forward card">
			<div class="card-body">
            <h2 class="tt-title"><?php echo HEADING_RETURNING_CUSTOMER_SPLIT; ?></h2>
			<div class="form-default">
            <div class="information mb-2"><?php echo TEXT_RETURNING_CUSTOMER_SPLIT; ?></div>
			...
			<div class="row mt-3">
            <div class="col-auto mr-auto buttonRow forward"><?php echo zen_image_submit(BUTTON_IMAGE_LOGIN, BUTTON_LOGIN_ALT, '', 'btn-top btn-border'); ?></div>
            <div class="col-auto align-self-end buttonRow back important"><?php echo '<a href="' . zen_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?></div>
			</div>
            <?php echo '</form>'; ?>
			</div>
        </div>
