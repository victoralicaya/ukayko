...
<h1 id="indexCategoriesHeading" class="tt-title"><?php echo HEADING_TITLE_NESTED; ?></h1>
...
<h1 id="indexCategoriesHeading" class="tt-title"><?php echo $current_categories_name; ?></h1>
</div>
...
<div id="categoryImgListing" class="categoryImg tt-post-content"><?php echo wt_image(DIR_WS_IMAGES . $categories_image, '', SUBCATEGORY_IMAGE_TOP_WIDTH, SUBCATEGORY_IMAGE_TOP_HEIGHT); ?></div>
...
?>
<div id="categoryDescription" class="catDescContent category-description mt-3 pt-3 pb-3"><?php echo $current_categories_description;  ?></div>
<br class="clearBoth" />
